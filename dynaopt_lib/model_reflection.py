...
class ReflectionScoreDeployedCL:
    ...
    def __init__(self, same_length=False, score_change=False, model_file="./weights/reflection_scorer_weight.pt"):
        ...
        model_path = "models/FacebookAI-roberta-base"
        ...
        c_ckpt = torch.load(model_file, weights_only=True) 
        self.model.load_state_dict(c_ckpt, strict=False) 
