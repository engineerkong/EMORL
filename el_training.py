...
def config_training(args, objective, seed):
    ...
    model, tokenizer = get_model(
        ...
        lora=True if args.training_mode ==  "ensembled" else False
    )
    if args.training_mode ==  "ensembled":
    ...
    objectives = [objective] if args.training_mode == "ensembled" else objective
...
def main():
    ...
    parser.add_argument('--training_mode', type=str, default="ensembled", help="options: ensembled/centralized/fixed")
